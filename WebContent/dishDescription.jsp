            ...
            <div class="container" style="margin-top:10%">
                <div class="row">
                    <div class="col-sm-5" style="margin-top: 10%">
                        <img class="col-sm" src="<%="resources\\images\\"+CustomDishBean.getUniqname()+".jpg"%>" >
                    </div>
                
                    <div class="col-sm-5" style="margin-top: 10%">
                        <div class="jumbotron" class="col-sm">
                            <label type="text" class="label" id="exampleInputEmail1" ><b><%= CustomDishBean.getName()%></b></label><br>
                             <hr>
                            
                            <label type="text" class="label" id="exampleInputEmail1" ><i><%= CustomDishBean.getType()%></i></label><br>

                            <label type="text" class="" id="exampleInputEmail1" ><i><%= CustomDishBean.getGenere()%></i></label><br>

                            <label type="text" class="" id="exampleInputEmail1" ><i><%= CustomDishBean.getTaste()%></i></label><br>

                            <label type="text" class="" id="exampleInputEmail1" ><i><%= CustomDishBean.getTime()%></i></label><br>

                            <label type="text" class="" id="exampleInputEmail1" ><i><%= CustomDishBean.getAveragetime()%></i></label><br>

                            <label type="text" class="" id="exampleInputEmail1" ><i><%= CustomDishBean.getDescription()%></i></label><br>
                            
                            <label type="text" class="" id="exampleInputEmail1" ><i><%= CustomDishBean.getCal()%></i></label><br>
                        </div>   
                    </div> 
                </div>       
            </div>     
                        <div class="jumbotron" style="margin: 5%">
                            <label ><h1><b>Description</b></h1></label>
                                            <hr>
                            <p ><%= CustomDishBean.getDescription()%></p>
                        </div>            
       <%
